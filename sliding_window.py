...
pubsub_data= (
                ...
                | 'Window' >> beam.WindowInto(window.SlidingWindows(30,10)) #30 second window, that updates every 10 seconds. The time is using is the timestamp that GooglePubSub uses when publishing
